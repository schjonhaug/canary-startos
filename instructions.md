...
Canary requires an Electrum server for blockchain data. You can choose between **Electrs** (default) and **Fulcrum** in the service config.

If you don't have an Electrum server installed:
1. Go to the Marketplace and install **Electrs** or **Fulcrum**
2. Wait for it to sync with the blockchain (this may take several hours on first run)
3. In the Canary config, select which Electrum server to use
...
- **Privacy**: Using a local Electrum server keeps your wallet addresses private.

## Troubleshooting

### Wallet Not Syncing
1. Check that your Electrum server is running and fully synced
